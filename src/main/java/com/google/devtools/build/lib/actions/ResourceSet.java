...
public class ResourceSet implements ResourceSetOrBuilder {
  ...
  public static ResourceSet create(int localTestCount) {
    return create(ImmutableMap.of(), localTestCount);
  }

  public static ResourceSet create(double memory, double cpu) {
  ...
  public double get(String resource) {
    return has(resource) ? resources.get(resource) : 0;
  }
  ...
  public boolean equals(Object that) {
    ...
    return thatResourceSet.get("memory") == get("memory")
        && thatResourceSet.get("cpu") == get("cpu")
  ...
  public int hashCode() {
    int p = 239;
    return Doubles.hashCode(get("memory"))
        + Doubles.hashCode(get("cpu")) * p
